        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    {{ trans('global.create') }} {{ trans('cruds.thongBao.title_singular') }}
                </div>
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.thong-baos.store") }}" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group {{ $errors->has('ten_tb') ? 'has-error' : '' }}">
                            <label for="ten_tb">{{ trans('cruds.thongBao.fields.ten_tb') }}</label>
                            <input class="form-control" type="text" name="ten_tb" id="ten_tb" value="{{ old('ten_tb', '') }}">
