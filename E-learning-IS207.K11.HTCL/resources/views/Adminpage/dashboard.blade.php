...
<!-- //pie-chart --><!-- index page sales reviews visitors pie chart -->
	...
	<!-- requried-jsfiles-for owl -->
					<link href="{{ asset('css/adminpage_css/owl.carousel.css') }}" rel="stylesheet">
...
<body class="cbp-spmenu-push">
	...
	<!-- for amcharts js -->
			...
			<link rel="stylesheet" href="{{ asset('css/adminpage_css/export.css') }}" type="text/css" media="all" />
			...
			<div class="mid-content-top charts-grids">
				<div class="middle-content">
					...
					<div id="owl-demo" class="owl-carousel text-center">
						...
						<div class="item">
							<img class="lazyOwl img-responsive" data-src="{{ asset('images/slider6.jpg') }}" alt="name">
						</div>
						<div class="item">
							<img class="lazyOwl img-responsive" data-src="{{ asset('images/slider7.jpg') }}" alt="name">
						</div>
			...
			<div class="col-md-4 span_8">
				<div class="activity_box">
					...
					<div class="scrollbar" id="style-1">
						...
						<div class="activity-row">
							<div class="col-xs-3 activity-img"><img src='{{ asset('images/4.jpg') }}' class="img-responsive" alt=""/></div>
							<div class="col-xs-7 activity-desc">
						...
						<div class="activity-row">
							<div class="col-xs-3 activity-img"><img src='{{ asset('images/3.jpg') }}' class="img-responsive" alt=""/></div>
							<div class="col-xs-7 activity-desc">
						...
						<div class="activity-row">
							<div class="col-xs-3 activity-img"><img src='{{ asset('images/2.jpg') }}' class="img-responsive" alt=""/></div>
							<div class="col-xs-7 activity-desc">
				...
				<div class="activity_box activity_box1">
					...
					<div class="scrollbar" id="style-3">
						<div class="activity-row activity-row1">
							<div class="col-xs-3 activity-img"><img src='{{ asset('images/1.jpg') }}' class="img-responsive" alt=""/><span>06:01 AM</span></div>
						...
						<div class="activity-row activity-row1">
							<div class="col-xs-3 activity-img"><img src='{{ asset('images/1.jpg') }}' class="img-responsive" alt=""/><span>06:05 AM</span></div>
							<div class="col-xs-5 activity-img1">
								<div class="activity-desc-sub">
									<h5>Michael Chris</h5>
