        ...
        <div class="col-lg-12">
          ...
          <nav class="navbar navbar-expand-lg">
            <a class="navbar-brand logo" href="index.html">
              <img id="logo-img" class="img-center" src="images/logo-customizer/logo-color-3.png" alt="">
            </a>
    ...
    <div class="container">
      <div class="row align-items-center">
        ...
        <div class="col-lg-6 col-md-12 md-mt-5 md-mb-5">
          <h5 class=" wow fadeInDown" data-wow-duration="1.5s">Powerfull and Cretive Design</h5>
          <h1 class="mb-4 wow jackInTheBox" data-wow-duration="2s">Grow Your Software With <span class="text-theme">“Softino”</span></h1>
          <p class="lead mb-0 wow fadeInUp" data-wow-duration="2s" data-wow-delay="0.3s">Softino is an all-new stylish Software For device that can show you things. awareness, drive traffic, connect with customers.</p>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="container">
    <div class="row custom-mt-10">
      <div class="col-lg-8 col-md-12 ml-auto mr-auto">
        <div class="video-box">
          <img class="img-fluid" src="images/mackbook/01.png" alt="">
    ...
    <div class="row text-center mt-5">
      <div class="col-lg-10 col-md-12 ml-auto mr-auto">
        <h3 class="text-black font-weight-normal line-h-2">Softino is built for <span class="text-theme">Software</span> like you. With useful features an intuitive interface and <span class="text-theme">powerful Design</span> built by a community of developers, it helps you focus on what you do best.</h3>
      </div>
    </div>
  </div>
</section>
...
<section class="grey-bg pos-r" data-bg-img="images/bg/02.png">
        ...
        <div class="tab">
          <div class="row align-items-center">
            <div class="col-lg-4 col-md-12">
              <!-- Nav tabs -->
              <div class="section-title">
                <h2 class="title">Choose Your Best Affordable <span class="text-theme">Pricing plan</span></h2>
                <p class="mb-0 text-black">Softino Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderi</p>
              </div>
              <nav>
                  ...
                  <div class="row align-items-center">
                    ...
                    <div class="col-lg-6 col-md-6 md-mt-5">
                      <div class="price-table style-3 active">
                        ...
                        <a class="btn btn-white btn-circle mt-4" href="#" data-text="Purchase Now"> <span>P</span><span>u</span><span>r</span><span>c</span><span>h</span><span>a</span><span>s</span><span>e</span>
                          <span> </span><span>N</span><span>o</span><span>w</span>
                        </a>
                      </div>
                    </div>
...
<section class="pos-r o-hidden" data-bg-img="images/pattern/01.png">
  <div class="container">
    <div class="row text-center">
      <div class="col-lg-8 col-md-10 ml-auto mr-auto">
        <div class="section-title">
          <h2 class="title">You Can See our clients feedback <span class="text-theme">What You Say?</span></h2> 
        </div>
      </div>
    </div>
    <div class="row">
      <div class="col-md-12">
        <div id="testimonial-3" class="testimonial-carousel carousel slide testimonial-3" data-ride="carousel" data-interval="2500">
          <!-- Wrapper for slides -->
          <div class="row">
            <div class="col-lg-10 col-md-9 col-sm-8 ml-auto">
          ...
          <div class="controls">
            <ul class="nav">
              <li data-target="#testimonial-3" data-slide-to="0" class="active">
                <a href="#">
...
<section class="pos-r">
  ...
  <div class="container">
    <div class="row text-center">
      <div class="col-lg-8 col-md-12 ml-auto mr-auto">
        <div class="section-title">
          <h2 class="title">Have a look Creative <span class="text-theme">Blogs</span></h2>
          ...
          <ul class="list-unstyled">
            <li class="mb-3">
              ...
              <div class="recent-post-desc">
                ...
                </div> <a href="blog-single.html">Softino Performance Based Software</a> 
              </div>
            </li>
            <li class="mb-3">
              ...
              <div class="recent-post-desc">
                ...
                </div> <a href="blog-single.html">latest Software design in features</a> 
              </div>
            </li>
            <li>
              <div class="recent-post-thumb">
              ...
              <div class="recent-post-desc">
                ...
                </div> <a href="blog-single.html">All Powerful Design feature In Softino</a> 
              </div>
            </li>
          </ul>
        </div>
...
<div class="color-customizer closed">
  ...
  <div class="clearfix color-chooser text-center">
    ...
    <ul class="colorChange clearfix">
      ...
      <li class="theme-3 selected" title="theme-3" data-style="color-3"></li>
